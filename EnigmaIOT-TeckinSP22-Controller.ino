...
#define RESET_PIN BUTTON // You can set a different configuration reset pin here. Check for conflicts with used pins.
...
void setup () {
	...
	EnigmaIOTNode.setResetPin (BUTTON); // Set reset pin
